...
$routes->group('admin', static function ($routes) {
    ...
    $routes->group('', ['filter' => 'cifilter:auth'], static function ($routes) {
        ...
        //pdf preview
        $routes->get('preview_siswa', 'PdfController::preview_siswa', ['as' => 'preview.siswa']);
        $routes->get('preview_pegawai', 'PdfController::preview_pegawai', ['as' => 'preview.pegawai']);
        $routes->get('hardware_preview/(:num)', 'PdfController::preview_hardware/$1', ['as' => 'hardware.preview']);
        $routes->get('software_preview/(:num)', 'PdfController::preview_software/$1', ['as' => 'software.preview']);
        $routes->get('preview_barang', 'PdfController::preview_barang', ['as' => 'preview.barang']);
        $routes->get('preview_ruangan', 'PdfController::preview_ruangan', ['as' => 'preview.ruangan']);
        $routes->get('preview_ta', 'PdfController::preview_ta', ['as' => 'preview.ta']);
        $routes->get('preview_jurusan', 'PdfController::preview_jurusan', ['as' => 'preview.jurusan']);
        $routes->get('preview_prodi', 'PdfController::preview_prodi', ['as' => 'preview.prodi']);
        $routes->get('preview_unit', 'PdfController::preview_unit', ['as' => 'preview.unit']);
        $routes->get('preview_jadwal/(:segment)', 'PdfController::preview_jadwal/$1', ['as' => 'preview.jadwal']);
        $routes->get('user_preview', 'PdfController::preview_user', ['as' => 'preview.user']);
        $routes->get('kritik_preview', 'PdfController::preview_kritik', ['as' => 'preview.kritik']);


        // $routes->get('preview-page', function () {
        //     return view('pdf_preview');
        // });

        $routes->post('save-notif', 'Jadwal::saveNotif', ['as' => 'user.reguler.jadwal']);
