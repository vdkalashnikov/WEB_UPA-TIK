        ...
        <form action="<?= route_to('user.login.handler'); ?>" class="login__form" method="post">
            ...
            <div class="login__inputs">
                <div class="login__box">
                    <input type="text" placeholder="Username" required class="login__input" name="login_id" value="<?= set_value('login_id'); ?>">
                ...
                <div class="login__box">
                    <input type="password" placeholder="Password" required class="login__input" name="password" value="<?= set_value('password'); ?>">
            ...
            <div class="login__check">
                <div class="login__check-box">
                    <a href="<?= route_to('user.forgot.password'); ?>" class="login__check-label text-white" style="text-decoration: none;">Forgot
                        Password</a>
                </div>
            </div>
