...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            ...
            <form action="/admin/jadwal-update/<?= $jadwal['id_jadwal']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_prodi" name="nama_prodi" value="<?= $jadwal['nama_prodi'] ?>">
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <select name="hari" id="hari" class="form-control">
                            <?php foreach ($hari as $day) : ?>
                                <option value="<?= $day ?>" <?php if ($jadwal['hari'] === $day) echo 'selected'; ?>>
                                    <?= $day ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <?php endif; ?>
                <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah anda yakin ingin mengedit data ini?');">Simpan
                    Data</button>
            </form>
        </div>
    </div>
