...
<div class="container">
    <div class="row text-center">
        <div class="col-lg-14 col-md-12 col-sm-12 tab">
            ...
            <a href="<?= route_to('export.vjadwal.pdf', $jenis = "UAS"); ?>" target="_blank" class="btn btn-warning mb-2">Export
				PDF</a>
			<a href="<?= route_to('export.jadwal-reguler.excel', $jenis = "UAS"); ?>" target="_blank" class="btn btn-success mb-2">Export
				Excel</a>
        </div>
    </div>
</div>
