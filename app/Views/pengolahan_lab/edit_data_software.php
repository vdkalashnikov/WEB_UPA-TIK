...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            ...
            <form action="/admin/update_data_software/<?= $software['id']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                    <img src="<?= base_url('img/' . $software['gambar']); ?>" alt="error" width="200px" class="img-thumbnail">
                </div>
                <div class=" row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Gambar</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="gambar" name="gambar" value="<?= $software['gambar']; ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $software['jumlah'] ?>">
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="id_ruangan" name="id_ruangan">
                            <?php foreach ($ruangan as $ruangan_item) : ?>
                                <option value="<?= $ruangan_item['id_ruangan'] ?>" <?= ($ruangan_item['id_ruangan'] == $software['id_ruangan']) ? 'selected' : '' ?>>
