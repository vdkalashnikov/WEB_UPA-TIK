...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            ...
            <form action="/admin/save_data_software" method="POST" enctype="multipart/form-data" <?= csrf_field() ?> <?php if (!empty(session()->getFlashdata('success'))) : ?> <div class="alert alert-success">
